...
def plot_batch_times(
    ...
    plt.plot(all_times_1, marker='o', color="blue", label="no-warmup and nested")
    plt.plot(all_times_2, marker='o', color="orange", label="no-warmup and padded")
    plt.plot(all_times_3, marker='o', color="green", label="warmup and nested")
    plt.plot(all_times_4, marker='o', color="red", label="warmup and padded")
    plt.title("All batch times")
